...
Instructions:
Wait for the profile instance to start (resources turn green, with a check mark in the corner).

Then, open a shell and log in to the controller - node-0.
...
This may take about 30 minutes. When it is finished, exit your SSH session, and open a *new* one.
